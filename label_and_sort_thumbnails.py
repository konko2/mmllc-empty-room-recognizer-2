...
if __name__ == '__main__':
    ...
    thumbnail_couples_with_scores = list(zip(thumbnail_couples, scores))
    sorted_thumbnail_couples_with_scores = sorted(
        thumbnail_couples_with_scores,
        key=lambda i: abs(52 - i[1])
    )

    for n, ((img1, img2), score) in enumerate(sorted_thumbnail_couples_with_scores):
        img1.save(f'data/scored/{n}_{score}_1.jpg')
        img2.save(f'data/scored/{n}_{score}_2.jpg')
